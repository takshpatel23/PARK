...
const Header = () => {
 const [showMobileMenu, setShowMobileMenu] = React.useState(false)
  ...
  <a
    href="/"
    className="mx-4 text-xl font-semi-bold transition text-black hover:text-cyan-400 hover:border-b-2 border-cyan-400"
  >
    About
  </a>
  ...
  <div className="absolute left-0 top-full p-2 mt-4 w-44 bg-gray-900 text-white text-lg font-semi-bold shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
    <a
      href='#OurStory'
      className="block px-4 py-2 mb-1 hover:bg-cyan-600 hover:text-white rounded-md transition duration-300"
    >
      Our Story
    </a>
    <a
      href='#OurDifference'
      className="block px-4 py-2 hover:bg-cyan-600 hover:text-white rounded-md transition duration-300"
    >
      Our Difference
    </a>
  </div>
  ...
  <div className="absolute left-0 top-full p-2  mt-4 w-52 bg-gray-900 text-white text-lg font-semi-bold shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
    <a
      ...
      className="block px-4 py-2 mb-2  hover:bg-cyan-600 hover:text-white rounded-md transition duration-300"
    >
      Product Management
    </a>
    <a
 ...
 <div className="relative group inline-block">
  ...
  >
    ...
    <a href='/services/UIUX' className="px-4 py-2 hover:bg-cyan-600 rounded-md transition">UI/UX</a>
            ...
            {/* <a href="/#Contact" className=' mx-4 text-xl font-semi-bold transition'>Contact</a> */}
<a
              href="/login"
              className="inline-block bg-[#0091FF] mx-4 hover:bg-[#0074CC] text-black px-5 py-3 rounded-2xl text-lg font-semibold transition"
            >
              Login
            </a>
                    </ul>
...
>
  ...
  <ul className="flex flex-col items-center gap-6 mt-10 text-xl">
    ...
    <a onClick={() => setShowMobileMenu(false)} href="#Services">Services</a>
